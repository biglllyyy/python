...
pool = redis.ConnectionPool(host='10.3.236.238', port=6379,db=0)
...
def updatetData():
    ...
    while True:
        ...
        r.hset("hash1", num, b)
        print(r.hget("hash1",num))
        count += 1

if __name__ == '__main__':
    print("start write redis data")
    # writeRedis()
    print("write redis finish ")
    p = Pool(64)
    for i in range(64):
        p.apply_async(updatetData)
